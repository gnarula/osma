...
using AgentOptions = Osma.Mobile.App.Services.Models.AgentOptions;
...
#endif
            Hyperledger.Aries.Configuration.AgentOptions ob = new Hyperledger.Aries.Configuration.AgentOptions();
            ob.WalletConfiguration = options.WalletOptions.WalletConfiguration;
            ob.WalletCredentials = options.WalletOptions.WalletCredentials;
            ob.EndpointUri = options.EndpointUri;
            ob.AgentDid = options.Did;
            ob.AgentKeySeed = options.Seed;
            ob.AgentName = options.Name;
            ob.PoolName = options.PoolOptions.PoolName;
            ob.GenesisFilename = options.PoolOptions.GenesisFilename;
            ob.ProtocolVersion = options.PoolOptions.ProtocolVersion;
            await _provisioningService.ProvisionAgentAsync(ob);
